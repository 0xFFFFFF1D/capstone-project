...
<nav class="orange darken-1" role="navigation">
    <div class="nav-wrapper container">
        <a name="logo-contaiid=" logo-container" href="../index.html" class="brand-logo header-font">AprilScheduler</a>
...
<main>
    <div class="container">
        <section>
            <form action="../php/scripts.php?func=registerUser()" method="POST">
                <div class="row">
                    <form class="col s12">
                        <div class="row">
